...
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[Gym].[Sessions]') AND [c].[name] = N'Description');
IF @var IS NOT NULL EXEC(N'ALTER TABLE [Gym].[Sessions] DROP CONSTRAINT ' + @var + ';');
ALTER TABLE [Gym].[Sessions] ALTER COLUMN [Description] nvarchar(200) NOT NULL;

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20260514151414_UpdateSessionDescriptionRange', N'11.0.0-preview.4.26230.115');
